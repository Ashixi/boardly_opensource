// У файлі deletedialog.dart, замініть весь вміст на:
  ...
  try {
    ...
    if (token != null) {
      ...
      if (response.statusCode != 200) {
        throw Exception('Failed to delete account on server: ${response.statusCode}');
      }
      ...
      if (context.mounted) {
        Navigator.of(context).pop(); // Закрити лоадер
        
        // 3. Перехід на стартовий екран
